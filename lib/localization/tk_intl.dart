...
// #enddocregion Raw
  ...
  @override
  String get expansionTileCollapsedHint => 'Un collapsed';

  @override
  String get expansionTileCollapsedTapHint => 'Collapsed';

  @override
  String get expansionTileExpandedHint => 'Un collapsed';

  @override
  String get expansionTileExpandedTapHint => 'Collapsed';
...
class _TkCupertinoLocalizationsDelegate
  ...
  Future<CupertinoLocalizations> load(Locale locale) async {
    ...
    final weekDayFormat = intl.DateFormat.d(localeName);
...
class CupertinoLocalizationTk extends GlobalCupertinoLocalizations {
  ...
  String tabSemanticsLabel({required int tabIndex, required int tabCount}) {
    assert(tabIndex >= 1, 'assertion');
    assert(tabCount >= 1, 'assertion');
